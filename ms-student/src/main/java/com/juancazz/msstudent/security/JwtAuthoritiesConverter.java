package com.juancazz.msstudent.security;
...
public class JwtAuthoritiesConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private String addAudPrefix(String role) {
        return String.format("AUD_%s", role);
    }

    private String addScopePrefix(String role) {
        return String.format("SCOPE_%s", role);
    }
    private String addGroupPrefix(String role) {
